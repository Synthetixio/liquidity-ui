...
import { ConvertStataUSDCTransaction } from './ConvertStataUSDCTransaction';
...
export const ConvertStataUSDCModal: FC<Props> = ({ onClose, isOpen, network, type, accountId }) => {
      ...
      <ModalContent mt="100px" borderWidth="1px" borderColor="gray.900" bg="navy.900" color="white">
        <Flex justifyContent="space-between" p={6} alignItems="center">
          <Heading fontSize="20px">
            {step === 2 ? 'Convertion successful' : 'Convert your USDC to stataUSDC'}
          </Heading>
